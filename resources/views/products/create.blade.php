...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-1">Fill in the information below to add a new product to your catalog.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <form method="POST" action="/products" class="p-6 md:p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="brand" value="{{ old('brand') }}" placeholder="e.g. Sony"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 transition-colors">
                    </div>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-5 border-t border-gray-100">
                    ...
                    <button type="submit"
                        class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition-colors flex items-center gap-2">
